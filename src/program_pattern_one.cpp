...
Program* createPatternProgramOne() {
    ...
    program->addSegment(0, new Segment(PATTERN_SPIN, allPins, 8, 15, spinParams));
    ...
    program->addSegment(1, new Segment(PATTERN_BREATHING, allPins, 8, 10, breathingParams));
    ...
    program->addSegment(2, new Segment(PATTERN_FLAME, allPins, 8, 10, flameParams));
    ...
    program->addSegment(3, new Segment(PATTERN_GROW, allPins, 8, 10, growParams));
    ...
    program->addSegment(4, new Segment(patterns, 3, 5));
    ...
    program->addSegment(5, new Segment(PATTERN_POP, allPins, 8, 20, popParams));
    ...
    program->addSegment(6, new Segment(symphonyPatterns, 4, 25));
