...
void popPattern(int pins[], int numPins, int speed, int holdDelay, CRGB palette[], int paletteSize, bool random,
    int accelerationTime, bool reverse = false);
void spinPattern(int pins[], int numPins, int speed, int separation, int span, CRGB palette[], int paletteSize,
    bool loop, bool continuous, bool blend, bool reverse = false);
